...
def upload_config():
    ...
    # upload_program_action: carica il file sul database
    prog_name = filename
    prog_descr = filename + " description"
    prog_file = filename
    ...
    # compile_program: compila il programma caricato in precedenza
    global openplc_runtime
    st_file = prog_file
    database = "openplc.db"
    conn = create_connection(database)
    ...
    return "Configuration " + st_file + " uploaded"
