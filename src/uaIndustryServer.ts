...
function postInitialize() {
    ...
    const relelement_associatedconfiguration_type = server.coreaas.createSubmodelRelationshipElement(server, "Associated Configuration Type", Kind.Type, "AssociatedConfiguration", submodel_IECResource_type, KeyElements.ConceptDescription, "http://www.test.com/061", "", KeyElements.Submodel, KeyType.URI, "", KeyElements.Submodel, KeyType.URI); 
    const property_description_type = server.coreaas.createSubmodelProperty(server, "IEC Resource Description Type", Kind.Type, "Description", [submodel_IECResource_type], KeyElements.ConceptDescription, "http://www.test.com/058", PropertyCategory.CONSTANT, PropertyValueType.String, "String", DataType.String, ""); 
    const property_addresslist_type = server.coreaas.createSubmodelProperty(server, "IEC Resource Address List Type", Kind.Type, "AddressList", [submodel_IECResource_type], KeyElements.ConceptDescription, "http://www.test.com/059", PropertyCategory.CONSTANT, PropertyValueType.String, "String", DataType.String, ""); 
    ...
    const elemcollection_OBschedorologio_type = server.coreaas.createSubmodelElementCollection(server, "OB Schedulazione Orologio", Kind.Type, "OBSchedulazioneOrologio", submodel_IECTask_type, KeyElements.ConceptDescription, "http://www.test.com/078", [property_priority_type, property_OBnumber_type, property_Period_type])
    ...
    const property_address_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Profibus Address Type", Kind.Type, "Address", undefined, KeyElements.ConceptDescription, "http://www.test.com/075", PropertyCategory.VARIABLE, PropertyValueType.Int, "Int16", DataType.Int16, 0); 
    ...
    server.coreaas.createConceptDescription(server, conceptDictionary, [file_datasheet_type], "Datasheet", "Datasheet", "File contenente il datasheet dell'asset", "", "www.test.com/004");
