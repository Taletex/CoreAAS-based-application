...
function postInitialize() {
    ...
    const property_address_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Profibus Address Type", Kind.Type, "ProfibusAddress", undefined, KeyElements.ConceptDescription, "http://www.test.com/075", PropertyCategory.VARIABLE, PropertyValueType.Int, "Int16", DataType.Int16, 0); 
    ...
    const elemcollection_profibusDP_type = server.coreaas.createSubmodelElementCollection(server, "Profibus DP", Kind.Type, "ProfibusDP", submodel_IECCommunication_type, KeyElements.ConceptDescription, "http://www.test.com/073", [property_hsa_type, property_address_type, property_bitrate_type, property_devicetype_type]);
    ...
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IOModule_type], "Submodel - IOModule", "IOModule", "Submodel contenente informazioni sui moduli di IO aggiuntivi", "", "www.test.com/053");
    ...
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECResource_type], "Submodel - IEC Resource", "IECResource", "Submodel contenente informazioni relative alla risorsa conforme allo standard IEC61131-3", "", "www.test.com/057");
    ...
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECProgram_type], "Submodel - IEC Program", "IECProgram", "Submodel contenente informazioni relative ai programmi conformi allo standard IEC61131-3", "", "www.test.com/060");
    server.coreaas.createConceptDescription(server, conceptDictionary, [relelement_resourceassociatedconfiguration_type], "Rel. Element - AssociatedConfiguration", "AssociatedConfiguration", "Relazione di appartenenza di una risorsa ad una configurazione", "", "www.test.com/061");
    server.coreaas.createConceptDescription(server, conceptDictionary, [relelement_associatedresource_type], "Rel. Element - AssociatedResource", "AssociatedResource", "Relazione di appartenenza di un programma ad una risorsa", "", "www.test.com/062");
    server.coreaas.createConceptDescription(server, conceptDictionary, [relelement_associatedtask_type], "Rel. Element - AssociatedTask", "AssociatedTask", "Relazione di appartenenza di un task ad un programma. Il valore indica il codice dell'OB", "", "www.test.com/063");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECCommunication_type], "Submodel - IECCommunication", "IECCommunication", "Submodel contenente informazioni relative alla modalità di comunicazione del PLC", "", "www.test.com/065");
    server.coreaas.createConceptDescription(server, conceptDictionary, [elemcollection_profinetIO_type], "Elem. Collection - ProfinetIO", "ProfinetIO", "Collection element contenente informazioni relative alla modalità di comunicazione Profinet IO del PLC", "", "www.test.com/066");
