...
function postInitialize() {
    ...
    const file_datasheet_type = server.coreaas.createSubmodelFile(server, "Data Sheet Type", Kind.Type, "DataSheet", submodel_configuration_type, KeyElements.ConceptDescription, "www.test.com/004", "", ""); 
    ...
    // PLC IO type
    const submodel_IO_type = server.coreaas.createSubmodel(server, "IO Type", Kind.Type, "IO", "http://www.test.com/IOType", KeyElements.ConceptDescription, "http://www.test.com/054", aas_plc);
    ...
    const submodel_IECResource_type = server.coreaas.createSubmodel(server, "IEC Resource Type", Kind.Type, "IECResource", "http://www.test.com/IECResourceType", KeyElements.ConceptDescription, "http://www.test.com/057", aas_plc);
    const relelement_resourceassociatedconfiguration_type = server.coreaas.createSubmodelRelationshipElement(server, "Associated Configuration Type", Kind.Type, "AssociatedConfiguration", submodel_IECResource_type, KeyElements.ConceptDescription, "http://www.test.com/061", "", KeyElements.Submodel, KeyType.URI, "", KeyElements.Submodel, KeyType.URI); 
    const property_resourcedescription_type = server.coreaas.createSubmodelProperty(server, "IEC Resource Description Type", Kind.Type, "Description", [submodel_IECResource_type], KeyElements.ConceptDescription, "http://www.test.com/058", PropertyCategory.CONSTANT, PropertyValueType.String, "String", DataType.String, ""); 
    const property_resourceaddresslist_type = server.coreaas.createSubmodelProperty(server, "IEC Resource Address List Type", Kind.Type, "AddressList", [submodel_IECResource_type], KeyElements.ConceptDescription, "http://www.test.com/059", PropertyCategory.CONSTANT, PropertyValueType.String, "String", DataType.String, ""); 

    // PLC IEC Program type
    const submodel_IECProgram_type = server.coreaas.createSubmodel(server, "IEC Program Type", Kind.Type, "IECProgram", "http://www.test.com/IECProgramType", KeyElements.ConceptDescription, "http://www.test.com/060", aas_plc);
    const file_programfile_type = server.coreaas.createSubmodelFile(server, "Program File Type", Kind.Type, "ProgramFile", undefined, KeyElements.ConceptDescription, "www.test.com/052", "", ""); 
    ...
    const relelement_associatedresource_type = server.coreaas.createSubmodelRelationshipElement(server, "Associated Resource Type", Kind.Type, "AssociatedResource", undefined, KeyElements.ConceptDescription, "http://www.test.com/062", "", KeyElements.SubmodelElementCollection, KeyType.idShort, "", KeyElements.Submodel, KeyType.URI); 
    const relelement_associatedtask_type = server.coreaas.createSubmodelRelationshipElement(server, "Associated Task Type", Kind.Type, "AssociatedTask", undefined, KeyElements.ConceptDescription, "http://www.test.com/063", "", KeyElements.SubmodelElementCollection, KeyType.idShort, "", KeyElements.SubmodelElementCollection, KeyType.idShort); 
    const elemcollection_program_type = server.coreaas.createSubmodelElementCollection(server, "Program", Kind.Type, "Program", submodel_IECProgram_type, KeyElements.ConceptDescription, "http://www.test.com/055", [file_programfile_type, property_programname_type, property_programdescription_type, property_language_type, relelement_associatedresource_type, relelement_associatedtask_type]);

    // PLC IEC Task type
    const submodel_IECTask_type = server.coreaas.createSubmodel(server, "IEC Task Type", Kind.Type, "IECTask", "http://www.test.com/IECTaskType", KeyElements.ConceptDescription, "http://www.test.com/077", aas_plc);
    const property_priority_type = server.coreaas.createSubmodelProperty(server, "IEC Task Priority Type", Kind.Type, "Priority", undefined, KeyElements.ConceptDescription, "http://www.test.com/080", PropertyCategory.VARIABLE, PropertyValueType.Int, "Int16", DataType.Int16, 0); 
    const property_OBnumber_type = server.coreaas.createSubmodelProperty(server, "IEC Task OB Number Type", Kind.Type, "OBnumber", undefined, KeyElements.ConceptDescription, "http://www.test.com/079", PropertyCategory.CONSTANT, PropertyValueType.Int, "Int16", DataType.Int16, 0); 
    const property_period_type = server.coreaas.createSubmodelProperty(server, "IEC Task Period Type", Kind.Type, "Period", undefined, KeyElements.ConceptDescription, "http://www.test.com/081", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0); 
    const property_triggerInputChannel_type = server.coreaas.createSubmodelProperty(server, "IEC Task Trigger Input Channel Type", Kind.Type, "Priority", undefined, KeyElements.ConceptDescription, "http://www.test.com/083", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0); 
    const elemcollection_OBcyclicinterrupt_type = server.coreaas.createSubmodelElementCollection(server, "OB Cyclic Interrupt", Kind.Type, "OBCyclicInterrupt", submodel_IECTask_type, KeyElements.ConceptDescription, "http://www.test.com/078", [property_priority_type, property_OBnumber_type, property_period_type]);
    const elemcollection_OBhwInterrupt_type = server.coreaas.createSubmodelElementCollection(server, "OB Hardware Interrupt", Kind.Type, "OBHardwareInterrupt", submodel_IECTask_type, KeyElements.ConceptDescription, "http://www.test.com/082", [property_priority_type, property_OBnumber_type, property_triggerInputChannel_type]);

    // PLC IEC Communication type
    const submodel_IECCommunication_type = server.coreaas.createSubmodel(server, "IEC Communication Type", Kind.Type, "IECCommunication", "http://www.test.com/IECCommunicationType", KeyElements.ConceptDescription, "http://www.test.com/065", aas_plc);
    const property_sendclocktime_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Send Clock Time Type", Kind.Type, "SendClockTime", undefined, KeyElements.ConceptDescription, "http://www.test.com/068", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0.0); 
    const property_updatetime_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Update Time Type", Kind.Type, "UpdateTime", undefined, KeyElements.ConceptDescription, "http://www.test.com/069", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0.0); 
    const property_respctrtime_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Response Control Time Type", Kind.Type, "ResponseControlTime", undefined, KeyElements.ConceptDescription, "http://www.test.com/070", PropertyCategory.VARIABLE, PropertyValueType.Int, "Int16", DataType.Int16, 0); 
    const property_ipaddress_type = server.coreaas.createSubmodelProperty(server, "IEC Communication IP Address Type", Kind.Type, "IPAddress", undefined, KeyElements.ConceptDescription, "http://www.test.com/072", PropertyCategory.VARIABLE, PropertyValueType.String, "String", DataType.String, ""); 
    const property_bandwidth_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Bandwidth Type", Kind.Type, "Bandwidth", undefined, KeyElements.ConceptDescription, "http://www.test.com/071", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0.0); 
    const property_hsa_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Highest Station Address Type", Kind.Type, "HSA", undefined, KeyElements.ConceptDescription, "http://www.test.com/076", PropertyCategory.VARIABLE, PropertyValueType.Int, "Int16", DataType.Int16, 0); 
    const property_profibusaddress_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Profibus Address Type", Kind.Type, "ProfibusAddress", undefined, KeyElements.ConceptDescription, "http://www.test.com/075", PropertyCategory.VARIABLE, PropertyValueType.Int, "Int16", DataType.Int16, 0); 
    const property_bitrate_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Bitrate Type", Kind.Type, "BitRate", undefined, KeyElements.ConceptDescription, "http://www.test.com/074", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0.0); 
    const property_devicetype_type = server.coreaas.createSubmodelProperty(server, "IEC Communication Device Type Type", Kind.Type, "DeviceType", undefined, KeyElements.ConceptDescription, "http://www.test.com/067", PropertyCategory.VARIABLE, PropertyValueType.String, "String", DataType.String, ""); 
    const elemcollection_profinetIO_type = server.coreaas.createSubmodelElementCollection(server, "Profinet IO", Kind.Type, "ProfinetIO", submodel_IECCommunication_type, KeyElements.ConceptDescription, "http://www.test.com/066", [property_sendclocktime_type, property_updatetime_type, property_respctrtime_type, property_ipaddress_type, property_bandwidth_type, property_devicetype_type]);
    const elemcollection_profibusDP_type = server.coreaas.createSubmodelElementCollection(server, "Profibus DP", Kind.Type, "ProfibusDP", submodel_IECCommunication_type, KeyElements.ConceptDescription, "http://www.test.com/073", [property_hsa_type, property_profibusaddress_type, property_bitrate_type, property_devicetype_type]);

    // SharedSubmodelElements type
    const property_terminal_type = server.coreaas.createSubmodelProperty(server, "Terminal Type", Kind.Type, "Terminal", [submodel_oven_type, submodel_vacuum_gripper_oven_type, submodel_turntable_type, submodel_vacuum_gripper_robot_type, submodel_sortingline_type, submodel_ahbwarehouse_type, submodel_IO_type, submodel_IOModule_type], KeyElements.ConceptDescription, "www.test.com/009", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0.0, {terminalType: '', terminalNumber: 'NaN', description: ''}, "http://www.test.com/terminalDataTemplate"); 
    ...
    const property_terminal1c_instance = server.coreaas.createSubmodelProperty(server, "Terminal Instance 1c (Motor)", Kind.Instance, "Terminal-MotorTurntable", [submodel_turntable_instance], KeyElements.ConceptDescription, "www.test.com/017", PropertyCategory.VARIABLE, PropertyValueType.Float, "Float", DataType.Float, 0.0, {terminalType: 'Output (Q1)', terminalNumber: '17', description:'motor turn-table counterclockwise'}, "http://www.test.com/terminalDataTemplate");  
    ...
    // Identification instance
    const submodel_identification_instance5 = server.coreaas.createSubmodel(server, "Identification Instance 5", Kind.Instance, "Identification", "http://www.test.com/identification5", KeyElements.Submodel, "http://www.test.com/identificationType", aas_plc);
    ...
    // Configuration instance
    const submodel_configuration_instance5 = server.coreaas.createSubmodel(server, "Configuration Instance 5", Kind.Instance, "Configuration", "http://www.test.com/configuration5", KeyElements.Submodel, "http://www.test.com/configurationType", aas_plc);
    ...
    const submodel_IECResource_instance = server.coreaas.createSubmodel(server, "IEC Resource Instance", Kind.Instance, "IECResource", "http://www.test.com/IECResource5", KeyElements.Submodel, "http://www.test.com/IECResourceType", aas_plc);
    server.coreaas.createSubmodelRelationshipElement(server, "Associated Configuration Instance", Kind.Instance, "AssociatedConfiguration", submodel_IECResource_instance, KeyElements.ConceptDescription, "", "http://www.test.com/IECResource5", KeyElements.Submodel, KeyType.URI, "http://www.test.com/IECConfiguration5", KeyElements.Submodel, KeyType.URI); 
    ...
    const submodel_IECProgram_instance = server.coreaas.createSubmodel(server, "IEC Program Instance", Kind.Instance, "IECProgram", "http://www.test.com/IECProgram5", KeyElements.Submodel, "http://www.test.com/IECProgramType", aas_plc);
    ...
    const relelement_associatedresource_instance1 = server.coreaas.createSubmodelRelationshipElement(server, "Associated Resource Instance 1", Kind.Instance, "AssociatedResource", undefined, KeyElements.ConceptDescription, "", "MainProgram", KeyElements.SubmodelElementCollection, KeyType.idShort, "http://www.test.com/IECResource5", KeyElements.Submodel, KeyType.URI); 
    ...
    const submodel_IECTask_instance = server.coreaas.createSubmodel(server, "IEC Task Instance", Kind.Instance, "IECTask", "http://www.test.com/IECTask5", KeyElements.Submodel, "http://www.test.com/IECTaskType", aas_plc);

    // PLC IEC Communication instance
    const submodel_IECCommunication_instance = server.coreaas.createSubmodel(server, "IEC Communication Instance", Kind.Instance, "IECCommunication", "http://www.test.com/IECCommunication5", KeyElements.Submodel, "http://www.test.com/IECCommunicationType", aas_plc);
    ...
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_identification_type], "Submodel - Identification", "Identification", "Submodel contenente informazioni sull'identificazione dell'asset", "", "www.test.com/001");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_asn_type], "Property - Asset serial number", "Asset serial number", "Numero seriale dell'asset", "", "www.test.com/002");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_configuration_type], "Submodel - Configuration", "Configuration", "Submodel contenente informazioni sulla configurazione dell'asset", "", "www.test.com/003");
    server.coreaas.createConceptDescription(server, conceptDictionary, [file_datasheet_type], "File - Datasheet", "Datasheet", "File contenente il datasheet dell'asset", "", "www.test.com/004");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_manufacturer_type], "Property - Asset Manufacturer", "Asset Manufacturer", "Produttore dell'asset", "", "www.test.com/005");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_vacuum_gripper_oven_type, submodel_vacuum_gripper_robot_type], "Submodel - Vacuum Gripper", "Vacuum Gripper", "Elemento responsabile dello spostamento dei blocchi di produzione", "", "www.test.com/006");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_pickup_type], "Operation - Pick Up", "Pick Up", "Operazione di sollevamento del blocco di produzione per effettuarne lo spostamento", "", "www.test.com/007");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_oven_type], "Submodel - Oven", "Oven", "Forno per il processamento dei blocchi di produzione", "", "www.test.com/008");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_terminal_type], "Property - Terminal", "Terminal", "Terminale di input o output", "V", "www.test.com/009");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_burn_type], "Operation - Burn", "Burn", "Operazione di accensione del forno", "", "www.test.com/010");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_turntable_type], "Submodel - Turntable", "Turntable", "Elemento preposto alla rotazione dei blocchi di produzione", "", "www.test.com/011");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_turntable_type], "Submodel - Turntable", "Turntable", "Elemento preposto alla rotazione dei blocchi di produzione", "", "www.test.com/011");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_activatesaw_type], "Operation - Activate Saw", "Activate Saw", "Operazione di attivazione della sega circolare per la lavorazione del blocco di produzione", "", "www.test.com/013");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_ejection_type], "Operation - Ejection", "Ejection", "Operazione di emissione del blocco di produzione dalla turntable al nastro trasportatore", "", "www.test.com/014");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_activatebelt_type], "Operation - Activate Belt", "Activate Belt", "Operazione di abilitazione del nastro trasportatore per lo spostamento dei blocchi di produzione", "", "www.test.com/015");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_terminal1c_instance, property_terminal3a_instance, property_terminal4c_instance], "Property - Motor Terminal", "Motor Terminal", "Terminale relativo ad un motorino elettrico", "V", "www.test.com/017");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_setdown_type], "Operation - Set Down", "Set Down", "Operazione di rilascio del blocco di produzione per effettuarne lo spostamento", "", "www.test.com/018");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_sortingline_type], "Submodel - Sorting Line", "Sorting Line", "Elemento responsabile del riconoscimento del colore dei blocchi di produzione e del loro smistamento nei rispettivi magazzini", "", "www.test.com/022");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_colordetection_type], "Operation - Color Detection", "Color Detection", "Operazione di riconoscimento del colore del blocco di produzione", "", "www.test.com/023");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_slEjection_type], "Operation - Ejection", "Ejection", "Operazione di espulsione di un blocco di produzione verso un magazzino", "", "www.test.com/024");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_ahbwarehouse_type], "Submodel - AHBWarehouse", "AHBWarehouse", "Submodel per la gestione dei pezzi nel magazzino", "", "www.test.com/026");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_retrieving_type], "Operation - Retrieving", "Retrieving", "Operazione di recupero di un blocco di produzione dal magazzino", "", "www.test.com/028");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_move_robot_type], "Operation - Move", "Move", "Operazione di spostamento del braccio del vacuum gripper. Prende in input le coordinate di destinazione (x,y,z)", "", "www.test.com/029");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_move_type], "Operation - Move", "Move", "Operazione di spostamento del braccio del vacuum gripper dalla posizione iniziale a quella finale", "", "www.test.com/030");
    server.coreaas.createConceptDescription(server, conceptDictionary, [operation_turn_type], "Operation - Turn", "Turn", "Operazione di rotazione della turntable per portare il blocco in prossimità della sega", "", "www.test.com/031");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_terminal1a_instance, property_terminal2a_instance, property_terminal2b_instance, property_terminal2c_instance, property_terminal4a_instance, property_terminal4b_instance], "Property - Switch Terminal", "Switch Terminal", "Terminale relativo ad uno switch", "V", "www.test.com/040");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_terminal1b_instance, property_terminal3b_instance], "Property - Light barrier Terminal", "Light barrier Terminal", "Terminale relativo ad un sensore luminoso", "V", "www.test.com/041");
    server.coreaas.createConceptDescription(server, conceptDictionary, [file_programfile_type], "File - Program File", "ProgramFile", "Link ad un file contenente un programma IEC", "", "www.test.com/052");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IOModule_type], "Submodel - IO Module", "IOModule", "Submodel contenente informazioni sui moduli di IO aggiuntivi", "", "www.test.com/053");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IO_type], "Submodel - IO", "IO", "Submodel contenente informazioni sugli I/O dell'Asset", "", "www.test.com/054");
    server.coreaas.createConceptDescription(server, conceptDictionary, [elemcollection_program_type], "Elem. Collection - IEC Program", "Program", "Collection element contenente informazioni su un programma IEC", "", "www.test.com/055");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECConfiguration_type], "Submodel - IEC Configuration", "IECConfiguration", "Submodel contenente informazioni relative alla configurazione conforme allo standard IEC61131-3", "", "www.test.com/056");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECResource_type], "Submodel - IEC Resource", "IEC Resource", "Submodel contenente informazioni relative alla risorsa conforme allo standard IEC61131-3", "", "www.test.com/057");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_resourcedescription_type], "Property - IEC Resource Description", "Description", "Proprietà che descrive la risorsa IEC", "", "www.test.com/058");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_resourceaddresslist_type], "Property - IEC Resource Address List", "Address List", "Proprietà che descrive gli indirizzi della risorsa", "", "www.test.com/059");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECProgram_type], "Submodel - IEC Program", "IEC Program", "Submodel contenente informazioni relative ai programmi conformi allo standard IEC61131-3", "", "www.test.com/060");
    server.coreaas.createConceptDescription(server, conceptDictionary, [relelement_resourceassociatedconfiguration_type], "Rel. Element - AssociatedC onfiguration", "AssociatedConfiguration", "Relazione di appartenenza di una risorsa ad una configurazione", "", "www.test.com/061");
    server.coreaas.createConceptDescription(server, conceptDictionary, [relelement_associatedresource_type], "Rel. Element - Associated Resource", "AssociatedResource", "Relazione di appartenenza di un programma ad una risorsa", "", "www.test.com/062");
    server.coreaas.createConceptDescription(server, conceptDictionary, [relelement_associatedtask_type], "Rel. Element - Associated Task", "AssociatedTask", "Relazione di appartenenza di un task ad un programma. Il valore indica il codice dell'OB", "", "www.test.com/063");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECCommunication_type], "Submodel - IEC Communication", "IECCommunication", "Submodel contenente informazioni relative alla modalità di comunicazione del PLC", "", "www.test.com/065");
    server.coreaas.createConceptDescription(server, conceptDictionary, [elemcollection_profinetIO_type], "Elem. Collection - Profinet IO", "ProfinetIO", "Collection element contenente informazioni relative alla modalità di comunicazione Profinet IO del PLC", "", "www.test.com/066");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_devicetype_type], "Property - Device Type", "DeviceType", "Proprietà indicante il tipo di dispositivo: IO Controller o IO Device nel caso di ProfinetIO, Master o Slave nel caso di ProfibusDP", "", "www.test.com/067");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_sendclocktime_type], "Property - Send Clock Time", "SendClockTime", "valore reale indicante il l'intervallo di scambio dati tra controller e device. Da usare solo nel caso in cui il tipo sia IO Controller", "ms", "www.test.com/068");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_respctrtime_type], "Property - Response Control Time", "ResponseControlTime", " valore intero che indica quanti cicli di aggiornamento senza IO sono accettati. Da indicare solo nel caso in cui il tipo sia IO Device.", "", "www.test.com/070");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_bandwidth_type], "Property - Bandwidth", "Bandwidth", "reale indicante la massima larghezza di banda utilizzabile per lo scambio dati real time. Da indicare solo nel caso in cui il tipo sia IO Controller.", "ms", "www.test.com/071");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_ipaddress_type], "Property - IP Address", "IPAddress", "indirizzo IP del dispositivo Profinet IO", "", "www.test.com/072");
    server.coreaas.createConceptDescription(server, conceptDictionary, [elemcollection_profibusDP_type], "Elem. Collection - Profibus DP", "ProfibusDP", "Submodel contenente informazioni relative alla modalità di comunicazione Profibus DP del PLC ", "", "www.test.com/073");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_bitrate_type], "Property - Bit Rate", "BitRate", "bit rate della comunicazione Profibus DP", "Kbps", "www.test.com/074");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_profibusaddress_type], "Property - Profibus Address", "ProfibusAddress", "indirizzo profibus DP del device", "", "www.test.com/075");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_hsa_type], "Property - Highest Station Address", "HSA", "intero che indica il valore dell'indirizzo più alto ammissibile per una stazione attiva", "", "www.test.com/076");
    server.coreaas.createConceptDescription(server, conceptDictionary, [submodel_IECTask_type], "IEC Task", "IECTask", "Submodel contenente informazioni relative ai task conforme allo standard IEC61131-3", "", "www.test.com/077");
    server.coreaas.createConceptDescription(server, conceptDictionary, [elemcollection_OBcyclicinterrupt_type], "Cyclic Interrupt", "CyclicInterrupt", "Collection element contenente informazioni relative ai task ciclici", "", "www.test.com/078");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_OBnumber_type], "Property - OB Number", "OBnumber", "Intero indicante il numero dell'Organization Block (OB)", "", "www.test.com/079");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_priority_type], "Property - Priority", "Priority", "Intero indicante la priorità dell'Organization Block (OB)", "", "www.test.com/080");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_period_type], "Property - Period", "Period", "Periodo dell'OB schedulazione d'orologio", "", "www.test.com/081");
    server.coreaas.createConceptDescription(server, conceptDictionary, [elemcollection_OBhwInterrupt_type], "Elem. Collection - Hardware Interrupt", "HardwareInterrupt", "Collection element contenente informazioni relative ai task di interrupt hardware", "", "www.test.com/082");
    server.coreaas.createConceptDescription(server, conceptDictionary, [property_triggerInputChannel_type], "Property - Trigger Input Channel", "TriggerInputChannel", "Canale di input d'innesco", "", "www.test.com/083");
